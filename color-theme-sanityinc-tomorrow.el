  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      (outline-3 (:inherit nil :foreground ,comment))
      (outline-4 (:inherit nil :foreground ,aqua))
      (outline-5 (:inherit nil :foreground ,yellow))
      (outline-6 (:inherit nil :foreground ,orange))
      (outline-7 (:inherit nil :foreground ,blue))
      (outline-8 (:inherit nil :foreground ,purple))
      (outline-9 (:inherit nil :foreground ,comment))
